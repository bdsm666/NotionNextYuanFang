...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'c98c96f6aee38251bb7901bcaa8152a2',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionNext', // 您的昵称 例如 YuanFang5669
  BIO: process.env.NEXT_PUBLIC_BIO || '老先生坐而论道，少年郎起而行之', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://5699999.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '找m, 约炮，速推', // 网站关键词 英文逗号隔开
